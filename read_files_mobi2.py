...
for e in texto:
    if e[90:93].startswith('99'):
        ...
        try:
            cursor.execute("""
            INSERT INTO envio_notificacao (AUTO, codigo_returno, mensagem_retorno, hora, mensagem_envio, date_file)
            VALUES (?,?,?,?,?,?)
        ...
        try:
            cursor.execute("""
            INSERT INTO envio_notificacao (AUTO, codigo_returno, proprietario, hora, mensagem_envio, date_file)
            VALUES (?,?,?,?,?,?)
